...
%kdegB2=0.1383; % degradtion rate when wnt is present
...
% eps=y(23);%1;
 ...
 % Wnt=y(27);
  %Dest=y(28); %destruction complex cc
  %Bcat=y(29); %beta_catenin cc
...
%CYCD'
dydt(8)= (kw4_1+kw4_2*M) + V6*CD + k24r*CD - k24*CYCD*P27 - K10*CYCD ;
...
%dWnt/dt
%dydt(27)=ksynWnt*M-kdegWnt*Wnt;

%dDest/dt
%dydt(28)=ksynDest-(kdegD1+kdegD2*Wnt)*Dest;

%dBcat/dt
%dydt(29)=ksynB*Wnt-(kdegB1+kdegB2*Dest)*Bcat;
